...
export function FeedbackContentStep ({ feedbackType, onFeedbackSent, onFeedbackRestartRequest }: FeedbackTypeContentStepProps) {
         ...
         <form onSubmit={handleSubmitFeedback} className='my-4 w-full'>
            <textarea
               className='min-w-[304px] w-full min-h-[112px] text-sm placeholder-zinc-400 text-zinc-100
                        ...
                        focus:right-1 focus:outline-none resize-none scrollbar scrollbar-thumb-zinc-700
